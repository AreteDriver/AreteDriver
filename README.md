...
FastAPI backend · React dashboard · Quorum coordination protocol ([PyPI](https://pypi.org/project/convergentAI/)) · 13,100+ tests

### [BenchGoblins](https://benchgoblins.com) — AI Fantasy Sports Decision Engine
League-centric start/sit, trade analysis, and matchup projections. Live on Fly.io + Vercel.
Next.js · FastAPI · PostgreSQL · Redis · Stripe · 1,988 tests · 99% coverage
...
SQLite FTS5 · Custom NER · Auto-classification · 1,055 tests · 97% coverage
...
Static analysis · 17 lint rules · CI integration · Zero LLM dependency
...
2,500+ downloads · 1,892 tests · 96% coverage
